...
const DynamicDialog = ({ isOpen, closeDialog, selectedMaster, onSave, fields, initialData, action }) => {
  ...
  return (
    <Dialog  open={isOpen} onOpenChange={closeDialog}>
        ...
        <DialogContent className="max-w-full max-h-[80%] sm:max-w-md lg:max-w-3xl mx-4  h-[75%]">
          <DialogTitle className="pl-1">{`${action} ${selectedMaster.charAt(0).toUpperCase() + selectedMaster.slice(1)}`}</DialogTitle>
                  ...
                  <div key={index} className="flex flex-col gap-1 mb-2">
                    ...
                    {field.type === 'textarea' ? (
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-full p-0 pointer-events-auto" align="center">
                          <Calendar
                            mode="single"
          ...
          <DialogFooter>
            ...
            {action === 'Update' && <Button onClick={handleSubmit}>Update</Button>}
          </DialogFooter>
