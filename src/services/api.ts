...
export const baseApi = createApi({
  ...
  tagTypes: ['User', 'Post', 'Comment', 'Master', 'Application', 'Email','Ticket','TicketCategory','TicketComment','TicketHistory','TicketTask','UserSkill', 'SmlFile', 'Notification'], // Define entity types for cache invalidation
